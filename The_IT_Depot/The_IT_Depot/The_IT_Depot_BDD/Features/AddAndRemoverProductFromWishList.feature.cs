...
namespace The_IT_Depot_BDD.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("AddAndRemoverProductFromWishList")]
    public partial class AddAndRemoverProductFromWishListFeature
    {
...
#line 1 "AddAndRemoverProductFromWishList.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "AddAndRemoverProductFromWishList", "A short summary of the feature", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.CategoryAttribute("E2E-AddAndRemoveProductFromWishList")]
...
#line hidden
#line 16
    testRunner.When("User add the product to the wish list", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 17
    testRunner.Then("User wait for the wish list page with selected product to load", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 18
    testRunner.When("User remove the product from the wish list", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 19
    testRunner.Then("User check if the wish list is empty", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
